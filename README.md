<div align="center">
  ...
  <p align="center">
    ...
    <br/>
    200 tools across 23 categories, covering every major Houdini context.
    <br/><br/>
  </p>
...
**200 tools**, **8 resources**, and **9 prompts** serving **31 written workflow guides** out of the box.
...
| **LOPs/USD** | 19 | Stage inspection, prims, layers, composition, variants, lighting |
...
`tests/integration/` executes all 200 commands against live Houdini via
...
2. **MCP Server** (`python/fxhoudinimcp/`): A standalone Python process using FastMCP. Exposes 200 tools, 8 resources, and 9 prompts via the MCP protocol. Forwards tool calls to Houdini over HTTP.
